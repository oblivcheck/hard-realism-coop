...
public OnPluginStart()
{
	...
	hCvar_TpMode = CreateConVar("tp_pov_mode", "2", "Thirdperson to point of view mode (0 = disable 1 = Semi Events(Being Pounced but not when getting up) 2 = full)", FCVAR_NOTIFY, true, 0.0, true, 2.0);
