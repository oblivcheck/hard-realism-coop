...
//	RegConsoleCmd("sm_zs", ForceSurvivorSuicide, "Alive Survivor Suicide himself Command.");
	...
	g_hTakeControlBlock = 		CreateConVar("l4d_afk_commands_takecontrol_block", 				"0", 	"If 1, Block player from using 'sb_takecontrol' command in console.", FCVAR_NOTIFY, true, 0.0, true, 1.0);
