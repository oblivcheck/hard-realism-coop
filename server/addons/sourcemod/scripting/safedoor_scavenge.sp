...
public void OnPluginStart()
{
	...
	g_hMinTravelDistance = CreateConVar("safedoor_scavenge_min_dist", "1500.0", "The minimum distance between the brushed oil drum and the land mark", _, true, 0.0);
	g_hMaxTravelDistance = CreateConVar("safedoor_scavenge_max_dist", "4500.0", "The maximum distance between the brushed oil drum and the land mark", _, true, 0.0);
